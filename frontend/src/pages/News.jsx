            ...
            {others.concat(series.slice(1, 3)).map((a, i) => (
              <Reveal key={a.slug} delay={i * 0.06}>
                <a
                  ...
                  className="group flex h-full flex-col rounded-md border border-fg/10 bg-surface p-8 transition-[transform,border-color] duration-500 hover:-translate-y-1 hover:border-xo-blue/40"
                >
